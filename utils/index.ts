...
import { carsInterface } from "@/app/components/CarCard";
...
export async function FetchCars(filters: FilterProps) {
  ...
  const headers = {
    'x-rapidapi-key': 'b57f446914msh1a339b95c9b150bp11c621jsnee6de667c06a',
...
export const generateCarImageUrl = (car: carsInterface, angle?: string ) =>{
